      ...
      <Wrapper>
        <div className="flex flex-col items-center text-center justify-center overflow-hidden">
          ...
          >
            ...
            asperiores blanditiis tempore quod fugit molestias. Minus neque
            nihil voluptatem, voluptas provident inventore dolore quidem
            sapiente ullam deleniti quis quaerat expedita.
          </motion.p>
        </div>
        <ContactInput />
      </Wrapper>
